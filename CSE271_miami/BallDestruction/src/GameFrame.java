...
public class GameFrame extends JFrame {
    ...
    public GameFrame() {
        ...
        panel = new GamePanel(WINDOW_WIDTH - 10, WINDOW_HEIGHT - 100);
        panel.setPreferredSize(new Dimension(WINDOW_WIDTH - 10, WINDOW_HEIGHT - 100)); 
        ...
        fireButton.addActionListener(e -> fireButtonAction());
        bottomPanel.add(leftButton, BorderLayout.LINE_START);
        bottomPanel.add(fireButton, BorderLayout.CENTER);
        bottomPanel.add(rightButton, BorderLayout.LINE_END);

        JPanel topPanel = new JPanel(new BorderLayout());
        topPanel.add(new JLabel("Score: "), BorderLayout.LINE_START);
    ...
    private void leftButtonAction() {
    	panel.moveTurretLeft();
    }
    
    private void rightButtonAction() {
    	panel.moveTurretRight();
    }
