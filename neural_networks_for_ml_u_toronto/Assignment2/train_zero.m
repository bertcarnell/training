...
for epoch = 1:epochs
  ...
  for m = 1:numbatches
    ...
    % (b) back_propagated_deriv_2 = back_propagated_deriv_1 * embed_to_hid_weights; -- NO
    % (c) back_propagated_deriv_2 = back_propagated_deriv_1' * embed_to_hid_weights; -- NO
    % (d) back_propagated_deriv_2 = back_propagated_deriv_1 * embed_to_hid_weights'; -- NO
